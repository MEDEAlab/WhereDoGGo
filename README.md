...
### Citation
The manuscript for WhereDoGo? is currently under preparation. For now, please cite this GitHub repository as (Kolyfetis & Adam, 2024; https://github.com/MEDEAlab/WhereDoGGo). Also cite the programs and libraries used by the different modules as above.
